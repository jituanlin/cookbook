 ...
 * For more information, please see [this blog](https://polymona.github.io/%E5%87%BD%E6%95%B0%E5%BC%8F%E7%BC%96%E7%A8%8B/2020-08-09-monocle-ts-%E8%A1%A5%E5%85%85%E6%96%87%E6%A1%A3/)
 * */
...
export const lensName: optics.Lens<Movie, string> = optics.Lens.fromProp<
  Movie
>()('name');

export const optionalRating: optics.Optional<
  Movie,
  number
> = optics.Optional.fromOptionProp<Movie>()('rating');

export const isoMovies: optics.Iso<Movies, IDToMovies> = new optics.Iso<
  Movies,
  IDToMovies
>(
  movies =>
...
export const traversalTags: optics.Traversal<
  Movie,
  string
...
export const optionalDate: optics.Optional<Movie, Date> = optics.Lens.fromProp<
  Movie
>()('releaseTimeText').composePrism(
